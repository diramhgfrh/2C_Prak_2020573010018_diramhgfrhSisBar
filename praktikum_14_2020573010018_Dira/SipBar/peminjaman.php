...
<html lang="en">
  ...
  <thead>
    <tr>
      ...
      <th scope="col">waktu_peminjaman</th>
      <th scope="col">waktu_pengembalian</th>
  ...
  ?>
    <tr>
      ...
      <td><?php echo date ("d-m-Y H:i:s",strtotime($data['waktu_peminjaman'])) ?></td>
  ...
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
        ...
        <button <?php echo $s ?> class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#Modalhapus<?php echo $no ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
                ...
                <div class="modal fade" id="Modalhapus<?php echo $no ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                        <a href="proses/proses_hapus_peminjaman.php?id=<?php echo $data['kode_barang'] ?>" class="btn btn-danger">Hapus</a>
                      </div>
                    </div>
                  </div>
                </div>
